...
import { Package, User, Clock, Settings, CreditCard, Heart, ChevronDown, ChevronUp, Type, Palette } from 'lucide-react';
...
function AccountPage() {
  ...
  // Filtrer les commandes de l'utilisateur (simulation)
  const userOrders = orders.filter(order => order.shippingDetails.email === user.email);
