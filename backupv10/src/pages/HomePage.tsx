          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="relative">
              ...
              <div className="relative rounded-2xl overflow-hidden">
                ...
                >
                  <source src="https://player.vimeo.com/progressive_redirect/playback/805477719/rendition/720p/file.mp4?loc=external&signature=5fc5c89e1f19c0c8b1d1201f5d5ad87c4c6c5fc7e1c1c8c8f0e7e4f8f8f8f8f" type="video/mp4" />
                </video>
      ...
      <section className="py-32 bg-gradient-to-b from-gray-900 to-black relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Profitez de -20% sur votre première commande avec le code <strong>WELCOME20</strong>
          </p>
          <Link 
            to="/product"
            className="group relative inline-flex items-center gap-2 bg-gradient-to-r from-purple-600 via-pink-600 to-blue-600 
